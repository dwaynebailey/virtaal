...
project = u'Virtaal'
copyright = u'2013-2026, Translate'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
# Kept in sync by hand with virtaal/__version__.py's own `ver` - that
# module is the single source of truth (it's what bin/virtaal and the
# packaging scripts actually use), this is just documentation-facing.
#
...
# pixels large.
html_favicon = "../share/icons/virtaal.ico"
...
intersphinx_mapping = {
    # Confirmed live, 2026-08-26: all four resolve (HTTP 200 on
    # objects.inv) at these https:// URLs - the old http:// Python 2.7
    # entry in particular predates this codebase's own Python 3 port.
