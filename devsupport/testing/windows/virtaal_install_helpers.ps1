...
# matters, because at least one real report this session ("the unsaved
# marker seems to persist between reinstalls") was specifically about
# behaviour across an install/uninstall/reinstall cycle, something a
# bundle-only check structurally cannot catch. Built 2026-08-24 so that
# cycle can be driven reliably and repeatably on a real Windows machine
