...
for lang in open(path.join('po', 'LINGUAS'), encoding='utf-8'):
    ...
    convertmo(open(po_filename, encoding='utf-8'), open(mo_filename, 'w'), None)
...
# hicolor icons) - Linux-specific; macOS/Windows packaging happens
# through their own separate paths now (see module docstring above).
