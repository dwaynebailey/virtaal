...
class UndoModel(BaseModel):
    ...
    def __init__(self, controller):
        ...
        self.undo_stack = []
        # Entries undone since the last fresh edit, most-recent-last -
        # see push_redo()/pop_redo(). A new edit (push()/record_start())
        # invalidates whatever's here, same as any other undo/redo stack.
        self.redo_stack = []
