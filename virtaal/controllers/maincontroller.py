...
class MainController(BaseController):
    ...
    def open_file(self, filename=None, uri='', forget_dir=False):
        ...
        # confirmed the hard way, unbounded recursive stack growth and
        # a real multi-minute CI/local hang with no error output.
        # Bailing out on a re-entrant call, rather than just bounding
        # each level's own wait, is what actually stops the recursion.
